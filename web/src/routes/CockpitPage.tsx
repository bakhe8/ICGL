          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-100 text-indigo-700 border border-indigo-200 hover:bg-indigo-200 hover:text-indigo-900 transition-all text-sm font-bold"
              >
                <Workflow className="w-4 h-4" />
                وكلاء النظام (Agents Flow)
              </button>
            </div>
          </div>
