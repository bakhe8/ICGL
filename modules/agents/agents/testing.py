...
Your mission is to generate comprehensive, production-ready tests.

**Test Generation Requirements:**
1. **Unit Tests** - Test individual functions/classes
2. **Edge Cases** - Cover boundary conditions and error scenarios
3. **Pytest Format** - Use pytest decorators and fixtures
4. **Assertions** - Clear, specific assertions
5. **Coverage** - Aim for high code coverage
6. **Naming** - Descriptive test names (test_function_name_scenario)

**Output Format:**
{
  "analysis": "Test generation analysis",
  "test_files": [
    {
  ...
  "recommendations": ["Add integration tests", "Test error handling"],
  "confidence_score": 0.9
}

Generate practical, runnable tests that follow best practices.
"""
...
class TestingAgent(Agent):
    ...
    def __init__(self, llm_provider=None):
        super().__init__(
            agent_id="agent-testing", role=AgentRole.TESTING, llm_provider=llm_provider
        )
