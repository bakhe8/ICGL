...
class UIUXAgent(Agent):
    ...
    async def _analyze(self, problem: Problem, kb) -> AgentResult:
        ...
        try:
            ...
            ui_history = (
                steward_res.analysis if steward_res else "No recent UI records found."
            )
        except Exception:
    ...
    async def spawn_specialist(
        self, specialty_name: str, task: str, kb: Any
    ) -> AgentResult:
        """
        ...
        specialist.get_system_prompt = lambda: definition
