...
import { useWebSocket } from '@admin-ui/hooks/useWebSocket';
import { TraceVisualization } from '@admin-ui/components/TraceVisualization';
import { PolicyEditor } from '@admin-ui/components/PolicyEditor';
import { Chat } from '@admin-ui/components/Chat';
import './SCP.css';
...
export default function SCP() {
    ...
    // Load initial stats
    useEffect(() => {
        // eslint-disable-next-line react-hooks/set-state-in-effect -- تهيئة بيانات بعد التركيب
        loadStats();
    ...
    useEffect(() => {
        ...
        /* eslint-disable react-hooks/set-state-in-effect -- تحديث حالة دفق لحظي */
