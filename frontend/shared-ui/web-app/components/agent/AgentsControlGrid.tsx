...
import { fetchAgentGaps, getLatestAdr } from '@web-src/api/queries';
import type { AgentInfo } from '@web-src/routes/AgentsFlowPage/AgentCard';
import AgentCard from '@web-src/routes/AgentsFlowPage/AgentCard';
import AgentDetailsModal from '@web-src/routes/AgentsFlowPage/AgentDetailsModal';
import { fetchAgentHistory, fetchAgents, fetchAgentStats, fetchEvents, fetchIdeaSummary, fetchLatestAnalysis, fetchStatus } from '@web-src/routes/AgentsFlowPage/api';
import type { EventInfo } from '@web-src/routes/AgentsFlowPage/EventLog';
import EventLog from '@web-src/routes/AgentsFlowPage/EventLog';
import IdeaSummary from '@web-src/routes/AgentsFlowPage/IdeaSummary';
import StatusIndicators from '@web-src/routes/AgentsFlowPage/StatusIndicators';
import WorkflowBoard from '@web-src/routes/AgentsFlowPage/WorkflowBoard';
...
export default function AgentsControlGrid() {
    ...
    if (loading) return <div className="text-center text-gray-500 py-12">جاري تحميل الشبكة السيادية...</div>;
    ...
    return (
        <div className="space-y-6">
            <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    {/* Header removed as it will be in the parent page */}
                </div>
