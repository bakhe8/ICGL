...
interface PolicyCondition {
    type: string;
    operator: string;
    value: unknown; // value can be anything depending on condition
}

interface ConditionalPolicy extends PolicyData {
                            ...
                            {selectedPolicy.type === 'conditional' && 'conditions' in selectedPolicy && (
                                <div className="details-section">
                                    ...
                                    <div className="conditions-list">
                                        {(selectedPolicy as ConditionalPolicy).conditions?.map((cond, idx) => (
                                    ...
                                    {('fallback_policy' in selectedPolicy) && (selectedPolicy as ConditionalPolicy).fallback_policy && (
                                        <div className="fallback-info">
                                            <strong>Fallback:</strong> {(selectedPolicy as ConditionalPolicy).fallback_policy}
                                        </div>
                                    )}
                                </div>
                            )}
