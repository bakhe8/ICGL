...
import { fetchJson, postJson } from '../../../../client'; // Standardized path
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex gap-4 items-center">
                                        <button
                                            ...
                                            className={`flex-1 group relative overflow-hidden rounded-xl py-4 font-black transition-all ${signingId === item.id
