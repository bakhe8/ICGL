...
import type { AgentRegistryEntry } from '@web-src/types';
                ...
                >
                    <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex flex-col items-end">
                            <span className={`w-2 h-2 rounded-full mb-1 ${agent.status === 'active' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]' : 'bg-slate-700'}`} />
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        <div className="flex -space-x-2 rtl:space-x-reverse">
                            {/* Visual placeholders for capabilities */}
                            {[1, 2].map((i) => (
