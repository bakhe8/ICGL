    ...
    async def review_document_draft(self, doc_type: str, content: str) -> Dict[str, Any]:
        ...
        if self.has_intelligence:
            try:
                from ..core.llm import LLMRequest
                prompt = f"""
                You are a Governance Auditor reviewing a draft document.
                ...
                2. Does it have Enforcement/Consequences section (if policy)?
                3. Are there clear owners?
                
                Output JSON:
                {{
                    "approved": boolean,
                    "critique": "Short feedback string",
                    "score": 0-100
                }}
                """
                ...
                try:
                    ...
                    return {
                        "approved": False, 
                        "critique": "See detailed analysis below.",
