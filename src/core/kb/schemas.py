...
class SigningRequest:
    """
    A SigningRequest represents a pending action in the Executive Queue.
    """
    ...
    actions: List[Dict[str, Any]] = field(default_factory=list)  # JSON-serialized FileChanges
    timestamp: Timestamp = field(default_factory=now)
...
class AgentManifestEntry:
    """
    Entry in the agent manifest, describing capabilities and role.
    """
