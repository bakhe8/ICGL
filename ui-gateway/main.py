"""
UI Gateway: serves static UIs and proxies to the backend API.
Migrated from `api/simple_ui_server.py`.
"""
...
app = FastAPI(title="ICGL UI Gateway", version="1.0.0")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        try:
            ...
            pass
    port = int(os.getenv("UI_GATEWAY_PORT", port))

    print("🚀 Starting ICGL UI Gateway...")
    print("📍 Routes:")
    print("   /         - Landing Page")
