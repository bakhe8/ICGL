...
"""
    ...
    async def _generate_doc_recommendation(
        self, problem: Problem, needs_adr: bool
    ) -> str:
        """Generate documentation recommendation."""
        if needs_adr:
            return """
...
"""
    ...
    def create_adr(
        self, title: str, context: str, decision: str, consequences: str, author: str
    ) -> DocumentRecord:
        """Create a new ADR."""
...
"""
    ...
    def get_active_adrs(self) -> List[DocumentRecord]:
        ...
        return [
            ...
            if doc.doc_type == DocumentationType.ADR
            and doc.status != DocumentStatus.DEPRECATED
        ]
