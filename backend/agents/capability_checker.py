...
class CapabilityChecker:
    ...
    def check_capability_exists(self, capability: str) -> CapabilityCheckResult:
        ...
        for agent_id, agent in self.agents.items():
            for agent_cap in agent.capabilities:
                if (
                    cap_normalized in agent_cap.lower()
                    or agent_cap.lower() in cap_normalized
                ):
    ...
    def suggest_agent_creation(
        self, proposed_name: str, proposed_capabilities: List[str]
...
def check_before_creating_agent(
    ...
    """
    checker = CapabilityChecker()
    return checker.suggest_agent_creation(
        proposed_name="NewAgent", proposed_capabilities=proposed_capabilities
    )
